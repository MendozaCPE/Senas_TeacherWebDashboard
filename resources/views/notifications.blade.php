...
<div class="max-w-4xl mx-auto py-8">
    ...
    'challenge_completed' => ['bg' => '#F5F3FF', 'ring' => '#DDD6FE', 'text' => '#6D28D9', 'label_bg' => 'bg-purple-100', 'label_text' => 'text-purple-700'], // 🆕 ADD THIS
];
 ...
 $typeLabels = [
    ...
    'challenge_completed' => 'Challenge Completed', // 🆕 ADD THIS
];
@endphp
