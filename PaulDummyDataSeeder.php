...
class PaulDummyDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── 1. STUDENTS ──────────────────────────────────────────────
        $studentsData = [
            ['lrn'=>'123456789001','pin'=>'1111','first_name'=>'Liza',  'last_name'=>'Reyes',   'age'=>10,'grade_level'=>'4','section'=>'Sampaguita','program_type'=>'SPED','fsl_mastery_level'=>'Beginner',    'status'=>'active','total_xp'=>320, 'level'=>3,'streak_days'=>5, 'last_activity_date'=>$now->copy()->subDays(1)->toDateString()],
            ['lrn'=>'123456789002','pin'=>'2222','first_name'=>'Marco',  'last_name'=>'Santos',  'age'=>11,'grade_level'=>'5','section'=>'Sampaguita','program_type'=>'SPED','fsl_mastery_level'=>'Intermediate','status'=>'active','total_xp'=>750, 'level'=>7,'streak_days'=>12,'last_activity_date'=>$now->copy()->subDays(0)->toDateString()],
            ['lrn'=>'123456789003','pin'=>'3333','first_name'=>'Sofia',  'last_name'=>'Cruz',    'age'=> 9,'grade_level'=>'3','section'=>'Rosal',     'program_type'=>'SPED','fsl_mastery_level'=>'Beginner',    'status'=>'active','total_xp'=>100, 'level'=>1,'streak_days'=>2, 'last_activity_date'=>$now->copy()->subDays(3)->toDateString()],
            ['lrn'=>'123456789004','pin'=>'4444','first_name'=>'Rafael', 'last_name'=>'Garcia',  'age'=>12,'grade_level'=>'6','section'=>'Rosal',     'program_type'=>'SPED','fsl_mastery_level'=>'Advanced',    'status'=>'active','total_xp'=>1200,'level'=>11,'streak_days'=>20,'last_activity_date'=>$now->copy()->subDays(0)->toDateString()],
            ['lrn'=>'123456789005','pin'=>'5555','first_name'=>'Aimee',  'last_name'=>'Flores',  'age'=>10,'grade_level'=>'4','section'=>'Sampaguita','program_type'=>'SPED','fsl_mastery_level'=>'Beginner',    'status'=>'inactive','total_xp'=>50, 'level'=>1,'streak_days'=>0, 'last_activity_date'=>$now->copy()->subDays(14)->toDateString()],
        ];
        ...
        $lessonsData = [
            // Module 1
            ['module_id'=>$moduleIds[0],'title'=>'Letters A to E','description'=>'Hand shapes for FSL letters A, B, C, D, E.','lesson_type'=>'gesture','difficulty'=>'easy',  'module_order'=>1,'status'=>'published','published_at'=>$now->copy()->subDays(10)],
            ['module_id'=>$moduleIds[0],'title'=>'Letters F to J','description'=>'Hand shapes for FSL letters F, G, H, I, J.','lesson_type'=>'gesture','difficulty'=>'easy',  'module_order'=>2,'status'=>'published','published_at'=>$now->copy()->subDays(8)],
            ['module_id'=>$moduleIds[0],'title'=>'Letters K to O','description'=>'Hand shapes for FSL letters K, L, M, N, O.','lesson_type'=>'gesture','difficulty'=>'medium','module_order'=>3,'status'=>'published','published_at'=>$now->copy()->subDays(6)],
            // Module 2
            ['module_id'=>$moduleIds[1],'title'=>'Hello & Goodbye',   'description'=>'Signs for greeting and parting.', 'lesson_type'=>'gesture','difficulty'=>'easy',  'module_order'=>1,'status'=>'published','published_at'=>$now->copy()->subDays(7)],
            ['module_id'=>$moduleIds[1],'title'=>'Please & Thank You', 'description'=>'Polite expressions in FSL.',     'lesson_type'=>'gesture','difficulty'=>'easy',  'module_order'=>2,'status'=>'published','published_at'=>$now->copy()->subDays(5)],
            // Module 3
            ['module_id'=>$moduleIds[2],'title'=>'Numbers 1–5',  'description'=>'Counting from one to five.',  'lesson_type'=>'gesture','difficulty'=>'easy',  'module_order'=>1,'status'=>'published','published_at'=>$now->copy()->subDays(4)],
            ['module_id'=>$moduleIds[2],'title'=>'Numbers 6–10', 'description'=>'Counting from six to ten.',  'lesson_type'=>'gesture','difficulty'=>'easy',  'module_order'=>2,'status'=>'published','published_at'=>$now->copy()->subDays(2)],
        ];
        $lessonIds = [];
        ...
        // ── 8. LEARNING PATHS ─────────────────────────────────────────
        $lpData = [
            [0, 'Beginner',    'Learn basic FSL alphabet', 30, false],
            [1, 'Intermediate','Master greetings and numbers', 45, false],
            [2, 'Beginner',    'Start with alphabet basics', 20, false],
            [3, 'Advanced',    'Complete all modules',  60, true],
        ];
