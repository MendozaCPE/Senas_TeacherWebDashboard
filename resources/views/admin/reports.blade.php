        ...
        <div class="divide-y divide-slate-50">
            ...
            <div class="flex items-center gap-4 px-6 py-4">
                ...
                <div class="flex-1 flex flex-col gap-2">
                    ...
                    <div class="skeleton h-2 rounded w-full max-w-xs"></div>
                </div>
...
<div class="flex flex-col gap-4 pt-4 skeleton-hide">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
        ...
        {{-- Card 1: Total Escalated — navy gradient --}}
        <div class="text-white" style="border-radius:24px;padding:22px 24px;position:relative;overflow:hidden;transition:transform .2s ease,box-shadow .2s ease;border:1px solid #f1f5f9;background:linear-gradient(135deg,#0d326b 0%,#1e4b8f 55%,#1a6fd4 100%);">
            <div class="flex items-center justify-between mb-4">
                <span class="text-[11px] font-bold uppercase tracking-wider text-white/70">Total Escalated</span>
                <div class="w-10 h-10 rounded-xl bg-white/15 flex items-center justify-center">
                    <span class="material-symbols-outlined text-[20px] text-white">warning</span>
                </div>
            </div>
            <p class="text-[36px] font-black leading-none mb-1 text-white tracking-tight">{{ $totalReports }}</p>
            <p class="text-[12px] text-white/70 font-medium">escalated to admin</p>
        </div>

        {{-- Card 2: Awaiting Review — white --}}
        <div style="border-radius:24px;padding:22px 24px;position:relative;overflow:hidden;transition:transform .2s ease,box-shadow .2s ease;border:1px solid #f1f5f9;background:#fff;">
            <div class="flex items-center justify-between mb-4">
                <span class="text-[11px] font-bold uppercase tracking-wider text-slate-400">Awaiting Review</span>
                <div class="w-10 h-10 rounded-xl bg-blue-50 text-[#0d326b] flex items-center justify-center">
                    <span class="material-symbols-outlined text-[20px]">schedule</span>
                </div>
            </div>
            <p class="text-[36px] font-black leading-none mb-1 text-[#0d326b] tracking-tight">{{ $pendingReports }}</p>
            <p class="text-[12px] text-[#1a6fd4] font-medium">pending admin response</p>
        </div>

        {{-- Card 3: Closed by Admin — emerald --}}
        <div style="border-radius:24px;padding:22px 24px;position:relative;overflow:hidden;transition:transform .2s ease,box-shadow .2s ease;border:1px solid #d1fae5;background:#f0fdf4;">
            <div class="flex items-center justify-between mb-4">
                <span class="text-[11px] font-bold uppercase tracking-wider text-emerald-600">Closed by Admin</span>
                <div class="w-10 h-10 rounded-xl bg-emerald-100 text-emerald-700 flex items-center justify-center">
                    <span class="material-symbols-outlined text-[20px]">check_circle</span>
                </div>
            </div>
            <p class="text-[36px] font-black leading-none mb-1 text-emerald-700 tracking-tight">{{ $resolvedCount }}</p>
            <p class="text-[12px] text-emerald-600 font-medium">successfully resolved</p>
        </div>

        {{-- Card 4: All Time Reports — amber gradient --}}
        <div class="text-amber-950" style="border-radius:24px;padding:22px 24px;position:relative;overflow:hidden;transition:transform .2s ease,box-shadow .2s ease;background:linear-gradient(135deg,#f59e0b 0%,#facc15 50%,#fbbf24 100%);border:1px solid rgba(245,158,11,.5);box-shadow:0 4px 16px rgba(245,158,11,.22);">
            <div class="flex items-center justify-between mb-4">
                <span class="text-[11px] font-black uppercase tracking-wider text-amber-950/80">All Time Reports</span>
            ...
            <p class="text-[36px] font-black leading-none mb-1 text-amber-950 tracking-tight">{{ \App\Models\HelpRequest::count() }}</p>
            <p class="text-[12px] text-amber-950/80 font-bold">student help requests total</p>
        </div>
