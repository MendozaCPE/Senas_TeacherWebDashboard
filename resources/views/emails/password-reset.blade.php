...
<head>
    ...
    <title>Reset your SEÑAS password</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 25px 80px rgba(15,23,42,0.12);">
                    <tr>
                        <td style="background:linear-gradient(135deg,#0d326b 0%,#1e4b8f 50%,#1a6fd4 100%);padding:40px 32px;text-align:center;color:#ffffff;">
                            <h1 style="margin:0;font-size:28px;font-weight:800;letter-spacing:-0.03em;">Password reset request</h1>
                            <p style="margin:12px auto 0;max-width:420px;font-size:15px;line-height:1.75;opacity:.9;">Use the button below to securely set a new password for your SEÑAS teacher dashboard.</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:32px 32px 24px;">
                            <p style="margin:0 0 18px;font-size:16px;line-height:1.75;">Hi {{ $notifiable->name }},</p>
                            <p style="margin:0 0 24px;font-size:15px;line-height:1.75;color:#4b5563;">We received a request to reset the password for your SEÑAS account. If you made this request, click the button below to choose a new password. This link will expire in 60 minutes.</p>

                            <div style="text-align:center;margin:0 0 32px;">
                                <a href="{{ $url }}" style="display:inline-block;padding:16px 28px;border-radius:999px;background:#1C3D7A;color:#ffffff;text-decoration:none;font-size:15px;font-weight:700;">Reset password</a>
                            </div>

                            <p style="margin:0 0 18px;font-size:15px;line-height:1.75;color:#4b5563;">If you did not request a password reset, you can safely ignore this email. No changes will be made to your account.</p>
                            ...
                            <div style="padding:18px 20px;border-radius:18px;background:#f8fafc;border:1px solid #e5e7eb;color:#475569;font-size:14px;line-height:1.7;">
                                <strong style="display:block;margin-bottom:8px;color:#111827;">Need help?</strong>
                                Visit your SEÑAS dashboard or contact your administrator if you have any questions.
                            </div>
