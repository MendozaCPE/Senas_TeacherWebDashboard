...
Route::post('/student/login', [StudentAuthController::class, 'login'])->middleware('throttle:100,1');
...
Route::middleware(['auth:sanctum', 'throttle:300,1'])->group(function () {
    ...
    Route::get('/student/unlocked-modules', [StudentAuthController::class, 'getUnlockedModules']);
    
    Route::post('/student/award-custom-xp', [StudentAuthController::class, 'awardCustomXp']);
    
    Route::post('/student/challenge/complete', [StudentAuthController::class, 'completeChallenge']);
