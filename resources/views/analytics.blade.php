...
<head>
    ...
    <title>SEÑAS Teacher Portal - Analytics</title>
...
<body class="text-slate-800 font-sans antialiased flex h-screen overflow-hidden bg-[#f4f7f9]">
    ...
    <aside class="w-64 bg-[#f8f9fa] flex flex-col shadow-[2px_0_15px_rgba(0,0,0,0.03)] z-10 flex-shrink-0">
        ...
        <nav class="flex-1 flex flex-col space-y-2">
            ...
            <a href="/analytics" class="flex items-center space-x-4 px-6 py-4 bg-white text-[#0d326b] font-bold text-[15px] border-l-[6px] border-[#facc15] shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
        ...
        <header class="h-24 px-12 flex items-center justify-between flex-shrink-0 mt-2">
            ...
            <div class="flex items-center space-x-6">
                ...
                <div class="text-[15px] font-semibold">
                    <span class="text-[#0d326b]">Analytics</span>
                </div>
            </div>
        </header>
